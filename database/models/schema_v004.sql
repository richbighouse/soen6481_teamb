...
INSERT INTO `covid`.`assessment` (`id`, `date`, `viewedByNurse`, `fkPatientId`, `q_difficultyBreathing`, `q_ageRange`, `q_firstSymptoms`, `q_situation`, `q_secondSymptoms`, `q_hasBeenCloseContact`, `q_hasBeenTested`, `q_hasTraveled`, `assignedDoctorId`, `rejected`) VALUES (6, '2021-11-04', 0, 1, 1, NULL, NULL, NULL, NULL, 1, 1, 1, 11, 0);
INSERT INTO `covid`.`assessment` (`id`, `date`, `viewedByNurse`, `fkPatientId`, `q_difficultyBreathing`, `q_ageRange`, `q_firstSymptoms`, `q_situation`, `q_secondSymptoms`, `q_hasBeenCloseContact`, `q_hasBeenTested`, `q_hasTraveled`, `assignedDoctorId`, `rejected`) VALUES (7, '2021-11-05', 0, 6, 0, '5', 1, 0, NULL, 1, 1, 1, 11, 0);
INSERT INTO `covid`.`assessment` (`id`, `date`, `viewedByNurse`, `fkPatientId`, `q_difficultyBreathing`, `q_ageRange`, `q_firstSymptoms`, `q_situation`, `q_secondSymptoms`, `q_hasBeenCloseContact`, `q_hasBeenTested`, `q_hasTraveled`, `assignedDoctorId`, `rejected`) VALUES (8, '2021-11-06', 0, 7, 0, '6-17', 0, 0, 1, 0, 0, 0, 11, 0);
INSERT INTO `covid`.`assessment` (`id`, `date`, `viewedByNurse`, `fkPatientId`, `q_difficultyBreathing`, `q_ageRange`, `q_firstSymptoms`, `q_situation`, `q_secondSymptoms`, `q_hasBeenCloseContact`, `q_hasBeenTested`, `q_hasTraveled`, `assignedDoctorId`, `rejected`) VALUES (9, '2021-11-07', 0, 8, 0, '18+', 1, NULL, NULL, 0, 0, 0, 11, 0);
INSERT INTO `covid`.`assessment` (`id`, `date`, `viewedByNurse`, `fkPatientId`, `q_difficultyBreathing`, `q_ageRange`, `q_firstSymptoms`, `q_situation`, `q_secondSymptoms`, `q_hasBeenCloseContact`, `q_hasBeenTested`, `q_hasTraveled`, `assignedDoctorId`, `rejected`) VALUES (10, '2021-11-08', 0, 13, 0, '18+', 0, 1, NULL, 0, 1, 0, 11, 0);
